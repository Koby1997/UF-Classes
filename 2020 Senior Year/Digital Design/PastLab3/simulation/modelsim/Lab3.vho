...
SIGNAL \U_LED5|output~0_combout\ : std_logic;
SIGNAL \U_LED5|output~1_combout\ : std_logic;
SIGNAL \U_ADDER|GEN:4:FA_i|s~combout\ : std_logic;
SIGNAL \U_LED5|output~2_combout\ : std_logic;
...
-- Equation(s):
-- \U_ADDER|FA_0|cout~0_combout\ = (\button[0]~input_o\ & ((\switch[0]~input_o\) # (\switch[5]~input_o\))) # (!\button[0]~input_o\ & (\switch[0]~input_o\ & \switch[5]~input_o\))
...
-- Equation(s):
-- \U_ADDER|GEN:1:FA_i|cout~0_combout\ = (\switch[6]~input_o\ & ((\switch[1]~input_o\) # (\U_ADDER|FA_0|cout~0_combout\))) # (!\switch[6]~input_o\ & (\switch[1]~input_o\ & \U_ADDER|FA_0|cout~0_combout\))
...
PORT MAP (
	...
	datac => \U_ADDER|FA_0|cout~0_combout\,
...
-- Equation(s):
-- \U_ADDER|FA_0|s~0_combout\ = \button[0]~input_o\ $ (\switch[0]~input_o\ $ (\switch[5]~input_o\))
...
-- Equation(s):
-- \U_ADDER|GEN:1:FA_i|s~combout\ = \switch[6]~input_o\ $ (\switch[1]~input_o\ $ (\U_ADDER|FA_0|cout~0_combout\))
...
-- Equation(s):
-- \U_LED4|output[0]~0_combout\ = (\U_ADDER|GEN:3:FA_i|s~combout\ & (\U_ADDER|FA_0|s~0_combout\ & (\U_ADDER|GEN:1:FA_i|s~combout\ $ (\U_ADDER|GEN:2:FA_i|s~combout\)))) # (!\U_ADDER|GEN:3:FA_i|s~combout\ & (!\U_ADDER|GEN:1:FA_i|s~combout\ & 
...
PORT MAP (
	...
	datab => \U_ADDER|FA_0|s~0_combout\,
	datac => \U_ADDER|GEN:1:FA_i|s~combout\,
...
-- Equation(s):
-- \U_LED4|output[1]~1_combout\ = (\U_ADDER|GEN:3:FA_i|s~combout\ & ((\U_ADDER|FA_0|s~0_combout\ & (\U_ADDER|GEN:1:FA_i|s~combout\)) # (!\U_ADDER|FA_0|s~0_combout\ & ((\U_ADDER|GEN:2:FA_i|s~combout\))))) # (!\U_ADDER|GEN:3:FA_i|s~combout\ & 
-- (\U_ADDER|GEN:2:FA_i|s~combout\ & (\U_ADDER|FA_0|s~0_combout\ $ (\U_ADDER|GEN:1:FA_i|s~combout\))))
...
-- Equation(s):
-- \U_LED4|output[2]~2_combout\ = (\U_ADDER|GEN:3:FA_i|s~combout\ & (\U_ADDER|GEN:2:FA_i|s~combout\ & ((\U_ADDER|GEN:1:FA_i|s~combout\) # (!\U_ADDER|FA_0|s~0_combout\)))) # (!\U_ADDER|GEN:3:FA_i|s~combout\ & (!\U_ADDER|FA_0|s~0_combout\ & 
-- (\U_ADDER|GEN:1:FA_i|s~combout\ & !\U_ADDER|GEN:2:FA_i|s~combout\)))
...
-- Equation(s):
-- \U_LED4|output[3]~3_combout\ = (\U_ADDER|FA_0|s~0_combout\ & ((\U_ADDER|GEN:1:FA_i|s~combout\ $ (!\U_ADDER|GEN:2:FA_i|s~combout\)))) # (!\U_ADDER|FA_0|s~0_combout\ & ((\U_ADDER|GEN:3:FA_i|s~combout\ & (\U_ADDER|GEN:1:FA_i|s~combout\ & 
...
-- Equation(s):
-- \U_LED4|output[4]~4_combout\ = (\U_ADDER|GEN:1:FA_i|s~combout\ & (!\U_ADDER|GEN:3:FA_i|s~combout\ & (\U_ADDER|FA_0|s~0_combout\))) # (!\U_ADDER|GEN:1:FA_i|s~combout\ & ((\U_ADDER|GEN:2:FA_i|s~combout\ & (!\U_ADDER|GEN:3:FA_i|s~combout\)) # 
...
-- Equation(s):
-- \U_LED4|output[5]~5_combout\ = (\U_ADDER|FA_0|s~0_combout\ & (\U_ADDER|GEN:3:FA_i|s~combout\ $ (((\U_ADDER|GEN:1:FA_i|s~combout\) # (!\U_ADDER|GEN:2:FA_i|s~combout\))))) # (!\U_ADDER|FA_0|s~0_combout\ & (!\U_ADDER|GEN:3:FA_i|s~combout\ & 
-- (\U_ADDER|GEN:1:FA_i|s~combout\ & !\U_ADDER|GEN:2:FA_i|s~combout\)))
...
-- Equation(s):
-- \U_LED4|output[6]~6_combout\ = (\U_ADDER|FA_0|s~0_combout\ & (!\U_ADDER|GEN:3:FA_i|s~combout\ & (\U_ADDER|GEN:1:FA_i|s~combout\ $ (!\U_ADDER|GEN:2:FA_i|s~combout\)))) # (!\U_ADDER|FA_0|s~0_combout\ & (!\U_ADDER|GEN:1:FA_i|s~combout\ & 
...
\U_LED5|output~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \U_LED5|output~0_combout\ = (\U_ADDER|GEN:3:FA_i|cout~0_combout\ & (!\switch[4]~input_o\ & !\switch[9]~input_o\)) # (!\U_ADDER|GEN:3:FA_i|cout~0_combout\ & (\switch[4]~input_o\ $ (\switch[9]~input_o\)))
...
PORT MAP (
	...
	datac => \switch[4]~input_o\,
	datad => \switch[9]~input_o\,
	combout => \U_LED5|output~0_combout\);

-- Location: LCCOMB_X77_Y37_N4
\U_LED5|output~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \U_LED5|output~1_combout\ = (\U_ADDER|GEN:3:FA_i|cout~0_combout\ & (\switch[4]~input_o\ $ (\switch[9]~input_o\))) # (!\U_ADDER|GEN:3:FA_i|cout~0_combout\ & (\switch[4]~input_o\ & \switch[9]~input_o\))
...
PORT MAP (
	...
	datac => \switch[4]~input_o\,
	datad => \switch[9]~input_o\,
	combout => \U_LED5|output~1_combout\);
...
\U_LED5|output~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \U_LED5|output~2_combout\ = (\U_ADDER|GEN:3:FA_i|cout~0_combout\) # ((\switch[4]~input_o\) # (\switch[9]~input_o\))
...
PORT MAP (
	...
	datac => \switch[4]~input_o\,
	datad => \switch[9]~input_o\,
	combout => \U_LED5|output~2_combout\);
