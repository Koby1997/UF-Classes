...
-- Design Ports Information
-- rco	=>  Location: PIN_B11,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- ld_n	=>  Location: PIN_B14,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \inst|sub|68~1_combout\ = (\inst|sub|68~0_combout\) # ((\clr_n~input_o\ & (\data0~input_o\ & !\ld_n~input_o\)))
...
-- Equation(s):
-- \inst1|sub|109~combout\ = \inst1|sub|111~q\ $ (((\inst1|sub|34~q\ & (\inst|sub|134~q\ & \inst|sub|130~0_combout\))))
...
-- Equation(s):
-- \inst1|sub|119~0_combout\ = (\inst1|sub|34~q\ & (\inst|sub|134~q\ & (\inst1|sub|111~q\ & \inst|sub|130~0_combout\)))
...
-- Equation(s):
-- \inst1|sub|126~0_combout\ = (\clr_n~input_o\ & ((\ld_n~input_o\) # (\data6~input_o\)))
...
\inst1|sub|128\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst1|sub|128~combout\ = (\inst1|sub|119~0_combout\ & (\inst1|sub|122~q\ & \inst1|sub|134~q\))
