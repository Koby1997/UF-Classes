...
SIGNAL \U_ALU|Mux0~32_combout\ : std_logic;
SIGNAL \U_ALU|Mux0~33_combout\ : std_logic;
...
-- Equation(s):
-- \U_ALU|Mux0~28_combout\ = (\switch[0]~input_o\ & (\switch[8]~input_o\ $ (((\switch[4]~input_o\) # (\button[1]~input_o\))))) # (!\switch[0]~input_o\ & (((\switch[4]~input_o\ & \switch[8]~input_o\)) # (!\button[1]~input_o\)))
...
-- Equation(s):
-- \U_ALU|Mux0~29_combout\ = (\U_ALU|Mux0~28_combout\ & ((\U_ALU|Add1~4_combout\) # ((\button[1]~input_o\) # (\switch[0]~input_o\))))
...
-- Equation(s):
-- \U_ALU|Mux0~14_combout\ = (!\switch[0]~input_o\ & ((\button[1]~input_o\ & (\switch[7]~input_o\)) # (!\button[1]~input_o\ & ((\switch[9]~input_o\)))))
...
-- Equation(s):
-- \U_ALU|Mux0~26_combout\ = (\button[1]~input_o\ & (\switch[6]~input_o\)) # (!\button[1]~input_o\ & (\switch[8]~input_o\ $ (((!\switch[6]~input_o\ & \switch[7]~input_o\)))))
...
-- Equation(s):
-- \U_ALU|Mux0~27_combout\ = (\button[1]~input_o\ & (((!\switch[0]~input_o\ & \U_ALU|Mux0~26_combout\)))) # (!\button[1]~input_o\ & ((\switch[0]~input_o\ & ((\U_ALU|Mux0~26_combout\))) # (!\switch[0]~input_o\ & (\switch[7]~input_o\))))
...
-- Equation(s):
-- \U_ALU|Mult0|auto_generated|le4a\(0) = \switch[5]~input_o\ $ (((\switch[6]~input_o\ & ((\switch[4]~input_o\) # (\switch[3]~input_o\))) # (!\switch[6]~input_o\ & (\switch[4]~input_o\ & \switch[3]~input_o\))))
...
-- Equation(s):
-- \U_ALU|Mux0~24_combout\ = (\button[1]~input_o\ & ((\U_ALU|Mult0|auto_generated|op_3~4_combout\) # ((\switch[0]~input_o\)))) # (!\button[1]~input_o\ & (((\U_ALU|Add0~4_combout\ & !\switch[0]~input_o\))))
...
-- Equation(s):
-- \U_ALU|Mux0~25_combout\ = \U_ALU|Mux0~24_combout\ $ (((\switch[0]~input_o\ & ((\switch[4]~input_o\) # (\switch[8]~input_o\)))))
...
-- Equation(s):
-- \U_ALU|Mux1~0_combout\ = (\switch[1]~input_o\ & ((\U_ALU|Mux0~27_combout\) # ((\button[0]~input_o\)))) # (!\switch[1]~input_o\ & (((!\button[0]~input_o\ & \U_ALU|Mux0~25_combout\))))
...
-- Equation(s):
-- \U_ALU|Mux1~1_combout\ = (\button[0]~input_o\ & ((\U_ALU|Mux1~0_combout\ & ((\U_ALU|Mux0~14_combout\))) # (!\U_ALU|Mux1~0_combout\ & (\U_ALU|Mux0~29_combout\)))) # (!\button[0]~input_o\ & (((\U_ALU|Mux1~0_combout\))))
...
-- Equation(s):
-- \U_ALU|Mux0~18_combout\ = (\switch[6]~input_o\ & (\button[1]~input_o\ & !\switch[0]~input_o\))
...
-- Equation(s):
-- \U_ALU|Mux0~15_combout\ = (!\switch[0]~input_o\ & ((\button[1]~input_o\ & ((\switch[7]~input_o\))) # (!\button[1]~input_o\ & (\switch[8]~input_o\))))
...
-- Equation(s):
-- \U_ALU|Add2~0_combout\ = \switch[9]~input_o\ $ (((\switch[8]~input_o\ & ((!\switch[7]~input_o\))) # (!\switch[8]~input_o\ & (\switch[6]~input_o\ & \switch[7]~input_o\))))
...
-- Equation(s):
-- \U_ALU|Mux0~16_combout\ = (\U_ALU|Mux0~15_combout\) # ((!\button[1]~input_o\ & (\switch[0]~input_o\ & \U_ALU|Add2~0_combout\)))
...
-- Equation(s):
-- \U_ALU|Mux0~22_combout\ = (\switch[0]~input_o\ & (\switch[9]~input_o\ $ (((\button[1]~input_o\) # (\switch[5]~input_o\))))) # (!\switch[0]~input_o\ & (((\switch[5]~input_o\ & \switch[9]~input_o\)) # (!\button[1]~input_o\)))
...
-- Equation(s):
-- \U_ALU|Mux0~23_combout\ = (\U_ALU|Mux0~22_combout\ & ((\switch[0]~input_o\) # ((\button[1]~input_o\) # (\U_ALU|Add1~6_combout\))))
...
PORT MAP (
	dataa => \switch[0]~input_o\,
	datab => \U_ALU|Mult0|auto_generated|op_3~6_combout\,
	datac => \U_ALU|Add0~6_combout\,
...
-- Equation(s):
-- \U_ALU|Mux0~19_combout\ = (\switch[1]~input_o\ & ((\U_ALU|Mux0~17_combout\ & (\U_ALU|Mux0~18_combout\)) # (!\U_ALU|Mux0~17_combout\ & ((\U_ALU|Mux0~16_combout\))))) # (!\switch[1]~input_o\ & (((\U_ALU|Mux0~17_combout\))))
...
PORT MAP (
	...
	datad => \U_ALU|Mux0~17_combout\,
	combout => \U_ALU|Mux0~19_combout\);

-- Location: LCCOMB_X57_Y53_N28
\U_ALU|Mux2~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \U_ALU|Mux2~2_combout\ = (\button[1]~input_o\ & (((\switch[3]~input_o\ & \switch[7]~input_o\)))) # (!\button[1]~input_o\ & (\U_ALU|Add1~2_combout\))
...
-- Equation(s):
-- \U_ALU|Mux2~1_combout\ = \switch[7]~input_o\ $ (((\switch[3]~input_o\) # (\button[1]~input_o\)))
...
-- Equation(s):
-- \U_ALU|Mux0~12_combout\ = (\button[1]~input_o\ & (\switch[9]~input_o\ & !\switch[0]~input_o\)) # (!\button[1]~input_o\ & ((\switch[0]~input_o\)))
...
-- Equation(s):
-- \U_ALU|Mux0~13_combout\ = (\button[1]~input_o\ & (((\U_ALU|Mux0~12_combout\)))) # (!\button[1]~input_o\ & (\switch[6]~input_o\ $ (((\switch[7]~input_o\ & \U_ALU|Mux0~12_combout\)))))
...
-- Equation(s):
-- \U_ALU|Mux0~30_combout\ = (\button[1]~input_o\ & ((\U_ALU|Mult0|auto_generated|op_3~2_combout\) # ((\switch[0]~input_o\)))) # (!\button[1]~input_o\ & (((\U_ALU|Add0~2_combout\ & !\switch[0]~input_o\))))
...
-- Equation(s):
-- \U_ALU|Mux0~31_combout\ = \U_ALU|Mux0~30_combout\ $ (((\switch[0]~input_o\ & ((\switch[3]~input_o\) # (\switch[7]~input_o\)))))
...
-- Equation(s):
-- \U_ALU|Mux2~0_combout\ = (\button[0]~input_o\ & (((\switch[1]~input_o\)))) # (!\button[0]~input_o\ & ((\switch[1]~input_o\ & (\U_ALU|Mux0~13_combout\)) # (!\switch[1]~input_o\ & ((\U_ALU|Mux0~31_combout\)))))
...
-- Equation(s):
-- \U_ALU|Mux2~3_combout\ = (\switch[0]~input_o\ & (((\U_ALU|Mux2~1_combout\) # (\U_ALU|Mux2~0_combout\)))) # (!\switch[0]~input_o\ & (\U_ALU|Mux2~2_combout\ & ((!\U_ALU|Mux2~0_combout\))))
...
-- Equation(s):
-- \U_ALU|Mux2~4_combout\ = (\U_ALU|Mux2~3_combout\ & ((\button[0]~input_o\ $ (\U_ALU|Mux2~0_combout\)))) # (!\U_ALU|Mux2~3_combout\ & (\U_ALU|Mux2~0_combout\ & ((\switch[8]~input_o\) # (!\button[0]~input_o\))))
...
\U_ALU|Mux0~32\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \U_ALU|Mux0~32_combout\ = (\switch[0]~input_o\ & (((\button[1]~input_o\)))) # (!\switch[0]~input_o\ & ((\button[1]~input_o\ & (\U_ALU|Mult0|auto_generated|op_3~0_combout\)) # (!\button[1]~input_o\ & ((\U_ALU|Add0~0_combout\)))))
...
PORT MAP (
	...
	combout => \U_ALU|Mux0~32_combout\);

-- Location: LCCOMB_X57_Y53_N14
\U_ALU|Mux0~33\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \U_ALU|Mux0~33_combout\ = \U_ALU|Mux0~32_combout\ $ (((\switch[0]~input_o\ & ((\switch[6]~input_o\) # (\switch[2]~input_o\)))))
...
PORT MAP (
	dataa => \switch[6]~input_o\,
	datab => \switch[2]~input_o\,
	datac => \U_ALU|Mux0~32_combout\,
	datad => \switch[0]~input_o\,
	combout => \U_ALU|Mux0~33_combout\);

-- Location: LCCOMB_X57_Y53_N26
\U_ALU|Mux0~10\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \U_ALU|Mux0~10_combout\ = (\button[1]~input_o\ & (\switch[8]~input_o\ & ((!\switch[0]~input_o\)))) # (!\button[1]~input_o\ & (((\switch[6]~input_o\ & \switch[0]~input_o\))))
...
-- Equation(s):
-- \U_ALU|Mux3~0_combout\ = (\button[0]~input_o\ & (((\switch[1]~input_o\)))) # (!\button[0]~input_o\ & ((\switch[1]~input_o\ & ((\U_ALU|Mux0~10_combout\))) # (!\switch[1]~input_o\ & (\U_ALU|Mux0~33_combout\))))
...
-- Equation(s):
-- \U_ALU|Mux0~8_combout\ = (\switch[0]~input_o\ & (((!\button[1]~input_o\) # (!\switch[6]~input_o\)))) # (!\switch[0]~input_o\ & (\switch[2]~input_o\ & (\switch[6]~input_o\ & \button[1]~input_o\)))
...
-- Equation(s):
-- \U_ALU|Mux0~9_combout\ = (\button[1]~input_o\ & (((\U_ALU|Mux0~8_combout\)))) # (!\button[1]~input_o\ & ((\U_ALU|Mux0~8_combout\ & ((\U_ALU|Add0~0_combout\))) # (!\U_ALU|Mux0~8_combout\ & (\U_ALU|Add1~0_combout\))))
...
-- Equation(s):
-- \U_ALU|Mux3~1_combout\ = (\U_ALU|Mux3~0_combout\ & ((\U_ALU|Mux0~11_combout\) # ((!\button[0]~input_o\)))) # (!\U_ALU|Mux3~0_combout\ & (((\button[0]~input_o\ & \U_ALU|Mux0~9_combout\))))
...
-- Equation(s):
-- \U_LED0|Mux6~0_combout\ = (\U_ALU|Mux1~1_combout\ & (!\U_ALU|Mux2~4_combout\ & (\U_ALU|Mux0~19_combout\ $ (!\U_ALU|Mux3~1_combout\)))) # (!\U_ALU|Mux1~1_combout\ & (\U_ALU|Mux3~1_combout\ & (\U_ALU|Mux0~19_combout\ $ (!\U_ALU|Mux2~4_combout\))))
...
-- Equation(s):
-- \U_LED0|Mux5~0_combout\ = (\U_ALU|Mux0~19_combout\ & ((\U_ALU|Mux3~1_combout\ & ((\U_ALU|Mux2~4_combout\))) # (!\U_ALU|Mux3~1_combout\ & (\U_ALU|Mux1~1_combout\)))) # (!\U_ALU|Mux0~19_combout\ & (\U_ALU|Mux1~1_combout\ & (\U_ALU|Mux2~4_combout\ $ 
...
-- Equation(s):
-- \U_LED0|Mux4~0_combout\ = (\U_ALU|Mux1~1_combout\ & (\U_ALU|Mux0~19_combout\ & ((\U_ALU|Mux2~4_combout\) # (!\U_ALU|Mux3~1_combout\)))) # (!\U_ALU|Mux1~1_combout\ & (!\U_ALU|Mux0~19_combout\ & (\U_ALU|Mux2~4_combout\ & !\U_ALU|Mux3~1_combout\)))
...
-- Equation(s):
-- \U_LED0|Mux3~0_combout\ = (\U_ALU|Mux3~1_combout\ & (\U_ALU|Mux1~1_combout\ $ (((!\U_ALU|Mux2~4_combout\))))) # (!\U_ALU|Mux3~1_combout\ & ((\U_ALU|Mux1~1_combout\ & (!\U_ALU|Mux0~19_combout\ & !\U_ALU|Mux2~4_combout\)) # (!\U_ALU|Mux1~1_combout\ & 
-- (\U_ALU|Mux0~19_combout\ & \U_ALU|Mux2~4_combout\))))
...
-- Equation(s):
-- \U_LED0|Mux2~0_combout\ = (\U_ALU|Mux2~4_combout\ & (((!\U_ALU|Mux0~19_combout\ & \U_ALU|Mux3~1_combout\)))) # (!\U_ALU|Mux2~4_combout\ & ((\U_ALU|Mux1~1_combout\ & (!\U_ALU|Mux0~19_combout\)) # (!\U_ALU|Mux1~1_combout\ & ((\U_ALU|Mux3~1_combout\)))))
...
-- Equation(s):
-- \U_LED0|Mux1~0_combout\ = (\U_ALU|Mux1~1_combout\ & (\U_ALU|Mux3~1_combout\ & (\U_ALU|Mux0~19_combout\ $ (\U_ALU|Mux2~4_combout\)))) # (!\U_ALU|Mux1~1_combout\ & (!\U_ALU|Mux0~19_combout\ & ((\U_ALU|Mux2~4_combout\) # (\U_ALU|Mux3~1_combout\))))
...
-- Equation(s):
-- \U_LED0|Mux0~0_combout\ = (\U_ALU|Mux3~1_combout\ & ((\U_ALU|Mux0~19_combout\) # (\U_ALU|Mux1~1_combout\ $ (\U_ALU|Mux2~4_combout\)))) # (!\U_ALU|Mux3~1_combout\ & ((\U_ALU|Mux2~4_combout\) # (\U_ALU|Mux1~1_combout\ $ (\U_ALU|Mux0~19_combout\))))
...
-- Equation(s):
-- \U_ALU|Mux4~1_combout\ = (\U_ALU|Mult0|auto_generated|op_3~14_combout\) # ((\U_ALU|Mult0|auto_generated|op_3~8_combout\) # ((\U_ALU|Mult0|auto_generated|op_3~10_combout\) # (\U_ALU|Mult0|auto_generated|op_3~12_combout\)))
...
-- Equation(s):
-- \U_ALU|Mux4~2_combout\ = (\button[1]~input_o\ & (!\switch[1]~input_o\ & \U_ALU|Mux4~1_combout\))
...
-- Equation(s):
-- \U_ALU|Mux4~3_combout\ = (!\switch[0]~input_o\ & (!\button[0]~input_o\ & ((\U_ALU|Mux4~2_combout\) # (\U_ALU|Mux4~0_combout\))))
